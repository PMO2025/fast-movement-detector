...
Детекция движущихся объектов в кадре со скоростью выше 5 км/ч.

- **Преимущество использования ML в решении данной бизнес-цели**

Линейные решения данной задачи отсутствуют.

- **Что будем считать успехом итерации с точки зрения бизнеса**

Использование продукта на согласованных для внедрения объектах.
...
Решение, прошедшее испытание на тестовых примерах.

- **Как именно мы будем использовать модель в существующем бизнес-процессе?**
...
- Краткое описание предполагаемого дизайна и способа оценки пилота , with `AB Group` 
